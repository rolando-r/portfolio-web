...
export const Navbar = () => {
    ...
    useEffect(() => {
        const handleScroll = () => {
            if (window.scrollY > 10) {  // puedes ajustar el umbral
                setScrolled(true);
            } else {
                setScrolled(false);
            }
    ...
    return (
        ...
        >
            <div
                className={`
                    flex items-center pl-10 px-4 py-2 space-x-4 rounded-full
            ...
            >
                <NavigationLinks />
                <div className="flex items-center space-x-5 text-sm font-semibold relative">
                    <LanguageToggle />
